					...
					<tr>
						...
						<td bgcolor="#f3ffe3"><table width="99%" border="0"
								...
								<tr class="listTr">
									<td class="td2">
										<p>
											设备UUID：<span>${device.deviceId}</span>
										</p>
										<p>
											设备类型：<span>${device.type}</span>
										</p>
										<p>
											备注：<span>${device.remark}</span>
										</p>
										<p>
											上次访问时间：<span>${device.lastlogintime_c}</span>
										</p>
										<p>
											是否允许访问：<span>${device.status_c}</span>
										</p></td>
								</tr>
							</table>
						</td>
