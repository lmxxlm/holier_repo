...
<script type="text/javascript" src="../resources/tab/scripts/account.js"></script>
<script language="javascript">
$(function(){
	function goPage() {
		var page = $("input[name='textfield']").val();
		location.href = "${mainUril}account.html?cp=" + page
				+ "&ps=${searchParam.ps}";
	}
});	
</script>
						...
						<td bgcolor="#f3ffe3"><table width="99%" border="0"
								...
								<tr>
									...
									<td width="10%" background="../resources/tab/images/tab_14.gif"
										class="STYLE1"><div align="center" class="STYLE2 STYLE1">账号id</div>
									</td>
									<td width="10%" background="../resources/tab/images/tab_14.gif"
										class="STYLE1"><div align="center" class="STYLE2 STYLE1">账户名</div>
									</td>
									<td width="10%" background="../resources/tab/images/tab_14.gif"
										class="STYLE1"><div align="center" class="STYLE2 STYLE1">用户组</div>
									</td>
									<td width="18%" background="../resources/tab/images/tab_14.gif"
										class="STYLE1"><div align="center" class="STYLE2 STYLE1">上次登录</div>
									</td>
									<td width="10%" background="../resources/tab/images/tab_14.gif"
										class="STYLE1"><div align="center" class="STYLE2 STYLE1">账号状态</div>
									</td>
									...
									<td width="9%" background="../resources/tab/images/tab_14.gif"
										class="STYLE1"><div align="center" class="STYLE2">权限</div>
									</td>
									<td width="9%" background="../resources/tab/images/tab_14.gif"
										class="STYLE1"><div align="center" class="STYLE2">删除</div>
									</td>
								</tr>
								<c:forEach items="${aro.accounts}" var="account"
									varStatus="status">
									<tr class="listTr">
										<td><input name="accountId" type="checkbox"
											value="${account.accountId}#${account.type}" class="selectall_unit" /></td>
										<td>${account.accountId}</td>
										<td>${account.name}</td>
										<td>${account.type}</td>
										<td>${account.lastlogintime_str}</td>
										<td>${account.status}</td>
										<td><img src="../resources/tab/images/a1.gif" width="9"
											height="9" />&nbsp;&nbsp;[<a
											<c:if test="${account.type eq '医生'}">href="accountDetailDoc.html?doctorId=${account.accountId}&&type=${account.type}" </c:if>
											<c:if test="${account.type eq '患者'}">href="accountDetailPat.html?patientId=${account.accountId}&&type=${account.type}" </c:if>
											>   
												详细</a>]</td>
										<td><img src="../resources/tab/images/037.gif" width="9"
											height="9" />&nbsp;&nbsp;[<a
										  	href="accountEdit.html?accountId=${account.accountId}&&type=${account.type}">编辑</a>]</td>
										<td><img src="../resources/tab/images/lock.png" width="10"
											height="10" />&nbsp;&nbsp;[<a
										  	href="accountPower.html?accountId=${account.accountId}&&type=${account.type}&&accountName=${account.name}">权限</a>]</td>  	
										<td><img src="../resources/tab/images/010.gif" width="9"
											height="9" />&nbsp;&nbsp;[<a href="#"
											onclick="deleteSingle('${account.accountId}','${account.name}','${account.type}')">删除</a>]</td>
									</tr>
								</c:forEach>
							</table></td>
						...
						<td background="../resources/tab/images/tab_21.gif"><table
								...
								<tr>
									<td width="25%" height="29" nowrap="nowrap"><span
										class="STYLE1">共${aro.acount}条纪录，当前第${searchParam.cp}/${aro.pcount}页，每页${searchParam.ps}条纪录</span>									
									</td>
											...
											<table width="352" height="20" border="0" cellpadding="0"
												...
												<tr class="pageline">
													<td width="62" height="22" valign="middle"><div
															align="right">
															<a
																href="${mainUril}account.html?cp=${aro.pageView.first}&&ps=${searchParam.ps}"><img
													...
													<td width="50" height="22" valign="middle"><div
															align="right">
															<a
																href="${mainUril}account.html?cp=${aro.pageView.back}&&ps=${searchParam.ps}"><img
													...
													<td width="54" height="22" valign="middle"><div
															align="right">
															<a
																href="${mainUril}account.html?cp=${aro.pageView.next}&&ps=${searchParam.ps}">
													...
													<td width="49" height="22" valign="middle"><div
															align="right">
															<a
																href="${mainUril}account.html?cp=${aro.pageView.last}&&ps=${searchParam.ps}"><img
