package com.danrong.camedex.controller;
...
import com.danrong.camedex.module.OrderService;
import com.danrong.camedex.module.OrderServiceImpl;
import com.danrong.camedex.util.CaPower;
...
public class OrderController {
  ...
  public ModelAndView allOrder(@ModelAttribute SearchParams param, HttpServletRequest request) {
    ...
    String power = sessionParser.getPower(request.getSession());
    String caId = null;
    if (CaPower.normal == Integer.parseInt(power)) caId = sessionParser.getUserName(request.getSession());
    OrderResultObject oro = orderService.get_order_list_by_status(param, StatusMapping.status_map.get(status), caId);
  ...
  public ModelAndView search_order(@ModelAttribute OrderSearchQ osq, @ModelAttribute SearchParams param,
    ...
    String power = sessionParser.getPower(request.getSession());
    if (CaPower.normal == Integer.parseInt(power)) osq.setCaId(sessionParser.getUserName(request.getSession()));
