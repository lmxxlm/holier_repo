...
<!--preloader end-->
				...
				<div class="container">
					...
					<nav class="collapse navbar-collapse">
						<ul class="nav navbar-nav">
							...
							<li><a href="#recover" class="on yahei">康复你我</a></li>
	...
	<div id="doctors">
        ...
        <!-- ------------------------ -------->
        <!-- appointment section -->
		<article class="section" style="padding-top:50px;">
				...
				<div class="container">
					...
					<div class="appointment-area">
						<div class="row">
											...
											<ul class="row">
												...
												<li class="col-sm-6">
													...
													<span class="input-date">
														<input type="text" placeholder="选择开始时间" class="form-control datepicker" value="" data-date-format="mm/dd/yy">
													</span>
												</li>
												<li class="col-sm-6">
													<label>结束时间</label>
													<span class="input-date">
														<input type="text" placeholder="选择结束时间" class="form-control datepicker" value="" data-date-format="mm/dd/yy">
													</span>
												</li>
												<li class="col-sm-12">
													<label>简介</label>
													<textarea placeholder="请输入相关简介" class="form-control"></textarea>
												</li>
												<li class="col-sm-12">
													<label>每小时的偏好</label>
													<ul class="row form-buttons">
														<li> <a href="#" class="btn btn-default">早晨</a> </li>
														<li> <a href="#" class="btn btn-default">中午</a> </li>
														<li> <a href="#" class="btn btn-default">晚上</a> </li>
													</ul>
												</li>
											</ul>
							...
							<div class="col-sm-6 appointment-box-snap"> <img src="resources/images/hosback2.png" style="height:500px;" alt="image doctor" > </div>
						</div>
					</div>
				</div>
			</div>
                              ...
                              <div class="row">
                                  ...
                                  <div class="activity-box media">
                                    ...
                                    <div class="media-body">
                                      ...
                                      <a href="http://115.29.201.245:8087/mobileApp/MedEx_Doctor.apk" class="btn btn-primary">安卓版下载</a>
                                    </div>
                                  </div>          
                                </div>
                                  <div class="col-sm-6">
                                  ...
                                  <div class="activity-box media">
                                    ...
                                    <div class="media-body">
                                      ...
                                      <a href="http://115.29.201.245:8087/mobileApp/MedEx_Patient.apk" class="btn btn-primary">安卓版下载</a>
                                    </div>
                                  </div>          
                                </div>
                                  <div class="col-sm-6">
