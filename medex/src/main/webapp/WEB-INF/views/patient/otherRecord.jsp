                        ...
                        <!-- 分页 -->
                         <div align="center">
							<ul class="pager">
								...
								<a href="${mainUril}otherRecord.html?patientId=${record.patientId}&&cp=${record.pageView.back}&&ps=${searchParam.ps}" >上一页</a>
								</li>
								<li     
									<c:if test="${oro.pageView.last == searchParam.cp}"> class="disabled"</c:if>>
									<a href="${mainUril}otherRecord.html?patientId=${record.patientId}&&cp=${record.pageView.next}&&ps=${searchParam.ps}"  >下一页</a>
								</li>
							</ul>
