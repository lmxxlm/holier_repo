				...
				<div class="calendartitle"><span class="glyphicon glyphicon-list-alt"></span>&nbsp;&nbsp;医生认证信息</div>
                        <div class="calendarList">
                            <table border="1" cellspacing="0" cellpadding="0" class="infoTable" width="100%">
                              ...
                              <tr>
                                <td class="td1">身份证：</td>
                                <td class="td2 IDcard">${doctor.identityID}</td>
                              ...
                              <tr>
                                ...
                                <td colspan="5" class="td3 zgzs" data-val="${doctor.qualification_pic.large}">
                              ...
                              <tr>
                                ...
                                <td colspan="5" class="td3 gzz" data-val="${doctor.license_pic.large}">
                              ...
                              <tr>
                                ...
                                <td colspan="5" class="td3 zczs" data-val="${doctor.employee_pic.large}">
	...
	$(function(){
		$('.accessV').click(function(){
			if (confirm('确定要通过该医生的认证申请吗？')) {
				...
				/*职称证书*/
				var zczs=$('.zczs').attr('data-val');
               /*判断资格证书*/
				var zgzs=$('.zgzs').attr('data-val');
				/*判断工作证或执业证书*/
				var gzz=$('.gzz').attr('data-val');
				if(!gzz && !zgzs && !zczs){
					alert("缺少工作证或资格证书或职称证书，不能通过验证");
					return false;
				}
