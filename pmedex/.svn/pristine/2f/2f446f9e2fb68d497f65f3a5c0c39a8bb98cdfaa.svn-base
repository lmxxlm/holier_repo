...
<!--                       <a href="product.html" class="glyphicons picture" onFocus="this.blur();"><i></i>产品一览</a> -->
                  ...
                  <div class="hidden-menu" id="ywcz">  
                      ...
                      <a href="jb_to_pay.html" class="glyphicons picture ypfjflb" onFocus="this.blur();"><i></i>应派发金币列表</a>
                      <a href="JBOperation.html" class="glyphicons picture beansOperation" onFocus="this.blur();"><i></i>积分派发</a>
                      ...
                      <a href="withdrawForRecureOrder.html?ps=36&&cp=1" class="glyphicons picture sub_zuddtx" onFocus="this.blur();"><i></i>转院订单提现</a>
                  </div>
...
<!--                   <a href="count_doctorCoins.html" class="glyphicons log_book sub_tjdd" onFocus="this.blur();"><i></i>统计订单</a> -->
                  ...
                  <a href="allOrderManager.html" class="glyphicons log_book  newOrderManager" onFocus="this.blur();"><i></i>手术订单管理</a>
                  <a href="kfTransferOrder.html" class="glyphicons log_book  kfTransferOrder" onFocus="this.blur();"><i></i>转院订单管理</a>
                 <!--  <a href="awardManager.html" class="glyphicons log_book  awardManager" onFocus="this.blur();"><i></i>授牌管理</a> -->
                   <!-- 康复信息管理 -->
                  ...
                  <div class="hidden-menu" id="kfgl">
                      ...
                      <a href="kfRegHospital.html" class="glyphicons comments kfRegHospital" onFocus="this.blur();"><i></i>新注册医院管理</a>
                  </div>
