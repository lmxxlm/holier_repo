	...
	<div class="container-fluid">
		...
		<div id="content">
			...
			<ol class="breadcrumb webmap">
				...
				<li class="active">申请派发积分</li>
			</ol>
			<form method="post" id="searchForm" action="${mainUrl}search_sqpfjf.do">
			...
			<div class="mainBody">
					...
					<tbody>
						...
						<c:forEach items="${oro.records}" var="order">
							...
							<tr>
								...
								<td class="td1">
								<a href="orderDetail.html?postType=sqpfjf&id=${order.orderId}">
								<span class="glyphicon glyphicon-zoom-in"></span>申请派发积分</a>&nbsp;&nbsp;
				...
				<div align="center">
					<ul class="pagination">
						...
						<!-- <a href="${mainUril}order_sqpfjf.html?cp=${oro.pageView.back}&&ps=${searchParam.ps}">上一页</a> -->
							<a href="javascript:void(0);" class="pre">上一页</a>
						</li>
						<li     
							<c:if test="${oro.pageView.last == searchParam.cp}"> class="disabled"</c:if>>
						<!-- <a href="${mainUril}order_sqpfjf.html?cp=${oro.pageView.next}&&ps=${searchParam.ps}">下一页</a> -->
