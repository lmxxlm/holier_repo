	...
	<div class="container-fluid">
		...
		<div id="content">
			...
			<ol class="breadcrumb webmap">
				...
				<li class="active">确认余款</li>
			</ol>
			<form method="post" id="searchForm" action="${mainUrl}search_qryk.do">
			...
			<div class="mainBody">
					...
					<tbody>
						...
						<c:forEach items="${oro.records}" var="order">
							...
							<tr>
								...
								<td class="td1">
								<a href="orderDetail.html?postType=qryk&id=${order.orderId}">
								<span class="glyphicon glyphicon-zoom-in"></span>确认余款</a>
								<!-- &nbsp;&nbsp;
				...
				<div align="center">
					...
					<!-- <a href="${mainUril}order_qryk.html?cp=${oro.pageView.back}&&ps=${searchParam.ps}">上一页</a> -->
							<a href="javascript:void(0);" class="pre">上一页</a>
						</li>
						<li     
							<c:if test="${oro.pageView.last == searchParam.cp}"> class="disabled"</c:if>>
						<!-- <a href="${mainUril}order_qryk.html?cp=${oro.pageView.next}&&ps=${searchParam.ps}">下一页</a> -->
