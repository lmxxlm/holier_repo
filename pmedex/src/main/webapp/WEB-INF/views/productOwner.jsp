		...
		<div id="content">
			...
			<div class="mainBody">
				...
				<table class="table table-striped table-hover">
					...
					<tr>
						<td>测试小明</td>
						<td>男${owner.gender}</td>
						<td>浙江医院${owner.referHospital}</td>
						<td>心内科${owner.referDepartments}</td>
						<td>副主任${owner.doctorTitle}</td>
						<td>手术搭桥<a href="ownerProduct.html?hostId=${owner.ownerId}">${owner.pcount}</a>
						</td>
						<td class="td1">
							<a href="ownerProduct.html?hostId=${owner.ownerId}"
										   data-id="${owner.ownerId}"
							               class="productOwnerDetail">
								          <span class="glyphicon glyphicon-zoom-in"></span>详情
							</a>&nbsp;&nbsp;&nbsp;&nbsp;
							<a href="javascript:void(0)" data-id="${owner.ownerId}"
								data-name="${owner.name}" class="addProduct"><span
								class="glyphicon glyphicon-plus"></span>添加产品</a>
						</td>
						<td class="td2" style="text-align:center;">
