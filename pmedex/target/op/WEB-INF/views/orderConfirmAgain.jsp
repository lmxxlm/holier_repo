...
<!--[if gt IE 8]><!--> <html class="no-js" lang=”zh”> <!--<![endif]-->
    ...
    <body>
        ...
        <div class="container-fluid">
            ...
            <div id="content">
                ...
                <ol class="breadcrumb webmap">
                  ...
                  <li><a href="orderDetail.html?postType=cxqrdd&id=${order.orderId}">订单详情</a></li>
					...
					<div class="float-form">
						...
						<div class="clearfix"></div>
                              ...
                              <tr>
                                ...
                                <td colspan="5" class="td3">
                                    <input type="text" readonly value="${order.confirmedTime}" name="serviceTime" class="form-control" placeholder="请选择服务时间">
                                </td>
                              </tr>
                              <tr>
                                <td class="td1">服务地点：</td>
                                <td colspan="5" class="td3">
                                    <textarea class="form-control notebook" readonly name="serviceAddr" placeholder="请输入服务地点">${order.confirmedLocation}</textarea>
                                </td>
                              </tr>
                              <tr>
                                <td class="td1">备注：</td>
                                <td colspan="5" class="td3">
                                    <textarea class="form-control notebook" name="serviceRemark" placeholder="请输入备注">${order.confirmedNote}</textarea>
                                </td>
                              </tr>
                              <tr>
                                <td class="td1">填写人：</td>
                              ...
                              <tr>
                                <td class="td1">财务反馈：</td>
                                <td colspan="5" class="td3">
                                    <textarea class="form-control notebook" name="serviceRemark" placeholder="请输入备注">${order.confirmedCheck}</textarea>
                                </td>
                              </tr>
                              <tr>
                                <td class="td1">&nbsp;</td>
        ...
        <script src="assets/script/productAdmin/orderConfirmAgain.js"></script>
    </body>
</html>