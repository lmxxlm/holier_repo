                            ...
                            <table border="1" cellspacing="0" cellpadding="0" class="infoTable" width="100%">
                              ...
                              <tr>
                                ...
                                <td class="td3" colspan="6">
                                    ...
                                    <c:if test="${order.status == '积分待派发'}"><button type="button" class="btn btn-primary" onclick="serviceComplete()"><span class="glyphicon glyphicon-edit"></span>&nbsp;&nbsp;派发积分</button></c:if>   
