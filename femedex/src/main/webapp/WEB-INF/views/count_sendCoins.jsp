...
<body>
			...
			<div class="searchBar row">
				...
				<div class="addPat col-md-6 col-xs-6" style="padding-right:0;">
				   <span class=" pull-right" style="margin-top:8px">
						总手动派发金币额度：<b style="color:red; font-size:18px;" id="exportCount">${jro.count}</b>
					</span>
				</div>
			</div>
			</form>
				...
				<div align="center">
					<ul class="pager">
						...
						<li     
							...
							href="${mainUril}count_sendCoins.html?cp=${jro.pageView.back}&&ps=${searchParam.ps}&&startTime=${startTime}&&endTime=${endTime}">下一页</a>
						</li>
					</ul>
	...
	function exportTable(testLink){
		...
		$.post(questURL,questArr,function(result){
			...
			if(data!=null){
				var str="操作号,对象医生,添补额度,添扣,操作时间,操作者\n";
				var x="";
