			...
			<div class="searchBar row">
				...
				<div class="addPat col-md-6 col-xs-6" style="padding-right:0;">
				   <span class=" pull-right" style="margin-top:8px">
						总金币余额：<b style="color:red; font-size:18px;" id="exportCount">${dcr.count}</b>
					</span>
				</div>
			</div>
			</form>
			...
			var questArr = {
				...
				if(data!=null){
					...
					for(var j=0;j<dataLenth;j++){
						...
						var test2='"'+data[j].accountId+'","'+data[j].doctorTitle+'","'+data[j].name+'","'+data[j].referDepartments+'","'+data[j].referHospital+'","'+data[j].scoreBalance+'"\n';
					    //var test2=data[j].accountId+","+data[j].doctorTitle+","+data[j].name+","+referDepartments+","+data[j].referHospital+","+data[j].scoreBalance+"\n";
						x+=test2;
					}
					var test=str+x+"\n总金币余额:"+exportCount;
